...
Contact: [security@vendcfo.ai](mailto:security@vendcfo.ai)

Based on [https://supabase.com/.well-known/security.txt](https://supabase.com/.well-known/security.txt)

At VendCFO, we consider the security of our systems a top priority. But no matter
...
- E-mail your findings to [security@vendcfo.ai](mailto:security@vendcfo.ai).
