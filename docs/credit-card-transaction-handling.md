...
This document explains how VendCFO handles credit card transactions from different banking providers to ensure correct categorization and amount signs.
...
| `cashAccountType` / `cash_account_type` | VendCFO Type |
|----------------------------------------|-------------|
| `CARD` | `credit` |
| `LOAN` | `other_asset` |
