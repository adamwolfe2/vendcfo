 ...
 *
 * - Production: "vendcfo"
 * - Staging:    "vendhub-staging"
 * - Dev:        "vendhub-dev"
 */
export function getDesktopScheme(): string {
  return process.env.NEXT_PUBLIC_DESKTOP_SCHEME || "vendcfo";
}
 ...
 *
 * @example
 * getDesktopSchemeUrl() // "vendhub://" in production, "vendhub-dev://" in dev
 */
 ...
 * ```typescript
 * // In production:
 * createDeepLink('dashboard');           // "vendhub://dashboard"
 * // In dev:
 * createDeepLink('transactions/123');    // "vendhub-dev://transactions/123"
 * ```
 */
