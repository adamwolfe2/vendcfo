    ...
    const blocks = [
      ...
      // Status Section
      {
        ...
        accessory: {
          ...
          url: "https://vendcfo.vercel.app/apps?app=slack&settings=true",
        ...
        elements: [
          {
            ...
            url: "https://vendcfo.vercel.app",
            action_id: "open_vendhub",
          },
          {
            type: "button" as const,
            text: {
      ...
      // Footer
      {
        ...
        elements: [
          {
            type: "mrkdwn" as const,
            text: "Upload receipts by sharing files in channels where VendCFO is added. Data will be automatically extracted and matched to your transactions.",
          },
        ],
      },
    ];
