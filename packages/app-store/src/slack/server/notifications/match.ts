import { getAppByAppId } from "@vendcfo/db/queries";
import { getWorkerDb } from "@vendcfo/db/worker-client";
            ...
            elements: [
              {
                ...
                url: `https://vendcfo.vercel.app/transactions?id=${encodeURIComponent(transactionId)}`,
          ...
          },
          {
            ...
            elements: [
              ...
              },
              {
                ...
                url: `https://vendcfo.vercel.app/inbox?inboxId=${encodeURIComponent(inboxId)}`,
