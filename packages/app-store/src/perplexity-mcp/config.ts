...
export default {
  ...
  logo: Logo,
  short_description:
    "Connect Perplexity to your VendCFO data with AI-powered search.",
  description: `Connect Perplexity to your VendCFO account using the Model Context Protocol (MCP).
...
3. Add your VendCFO API key and start asking questions`,
  images: [],
