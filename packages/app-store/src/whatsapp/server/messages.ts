...
export function formatWelcomeMessage(): string {
  const builder = new MessageBuilder();
  builder
    .header("Welcome to VendCFO")
    .blank()
    .line("To connect your WhatsApp:")
    .bullet("Scan the QR code in your VendCFO dashboard")
...
export function formatAlreadyConnectedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("You're already connected to VendCFO.")
    .blank()
...
export function formatAlreadyConnectedToAnotherTeamError(
  ...
  builder
    ...
    .line("from the current team first in your VendCFO dashboard.")
    .blank()
    .footer();
...
export function formatProcessingErrorMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("Please try again or upload it directly in VendCFO.")
    .blank();
...
export function formatNotConnectedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("Your WhatsApp is not connected to VendCFO yet.")
    .blank()
    .line("Please scan the QR code in your VendCFO dashboard to connect.")
    .blank();
...
export function formatMatchDeclinedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("You can review and match this receipt manually in VendCFO.")
    .blank()
    .footer();
...
export function formatMatchActionErrorMessage(
  ...
  builder
    ...
    .blank()
    .line("Please try again or handle this in VendCFO.")
    .blank()
    .footer();
