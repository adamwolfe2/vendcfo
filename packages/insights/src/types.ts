/**
 * Core types for the @vendcfo/insights package
 */

// Import and re-export InsightPredictions from schema (single source of truth)
import type { InsightPredictions } from "@vendcfo/db/schema";
...
// InsightPredictions is defined in @vendcfo/db/schema - import from there
