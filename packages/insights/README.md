...
AI-powered business insights generation for VendCFO. This package provides smart metric selection, anomaly detection, and narrative content generation for periodic business summaries.
...
```typescript
import { createInsightsService } from "@vendcfo/insights";
...
```typescript
import { isTeamEnabledForInsights, getEnabledTeamIds } from "@vendcfo/insights";
