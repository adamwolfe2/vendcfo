...
import { shouldSendNotification } from "@vendcfo/db/queries";
import InsightsWeeklyEmail from "@vendcfo/email/emails/insights-weekly";
import InvoiceEmail from "@vendcfo/email/emails/invoice";
import InvoiceOverdueEmail from "@vendcfo/email/emails/invoice-overdue";
import InvoicePaidEmail from "@vendcfo/email/emails/invoice-paid";
import InvoiceReminderEmail from "@vendcfo/email/emails/invoice-reminder";
import TransactionsEmail from "@vendcfo/email/emails/transactions";
import TransactionsExportedEmail from "@vendcfo/email/emails/transactions-exported";
import UpcomingInvoicesEmail from "@vendcfo/email/emails/upcoming-invoices";
...
export class EmailService {
  ...
  async #buildEmailPayload(email: EmailInput): Promise<CreateEmailOptions> {
    ...
    const payload: CreateEmailOptions = {
      from: email.from || "VendCFO <vendhubbot@vendcfo.ai>",
      to: recipients,
