...
```typescript
import { InboxAuthError, isInboxAuthError } from "@vendcfo/inbox/errors";
...
```typescript
import { InboxSyncError } from "@vendcfo/inbox/errors";
...
// Utility functions
import { isAuthenticationError } from "@vendcfo/inbox/utils";
```
