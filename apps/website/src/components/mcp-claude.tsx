...
import { ClaudeMcpLogo } from "@vendcfo/app-store/logos";
...
export function MCPClaude() {
  ...
  const cliCommand = useMemo(() => {
    ...
    return `claude mcp add --transport http vendhub https://api.vendhub.com/mcp --header "Authorization: Bearer ${key}"`;
  }, [apiKey]);
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="font-sans text-base text-muted-foreground leading-relaxed">
                Claude can pull live data from your VendCFO account to answer
            ...
            <div className="mt-12 space-y-4">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    {activeTab === "code"
                      ? "Use @vendcfo in Claude Code to access your data"
                      : "Restart Claude Desktop and use VendCFO tools"}
                  </span>
                </li>
              </ol>
            </div>
