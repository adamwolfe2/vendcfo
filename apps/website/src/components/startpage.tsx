...
const features = [
  ...
  },
  {
    ...
    subtitle:
      "VendCFO explains changes in cash, revenue, and spending as they happen.",
...
const videos = [
  {
    ...
    title: "Overview",
    subtitle:
      "See how VendCFO helps you run your business finances without manual work.",
    url: "https://cdn.vendhub.com/videos/login-video.mp4",
  },
  {
    id: "assistant",
    title: "Assistant",
    ...
    url: "https://cdn.vendhub.com/videos/login-video.mp4", // Replace with actual video URL
  },
  {
    id: "insights",
    title: "Insights",
...
export function StartPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="flex flex-col min-h-screen relative pt-32 pb-12 sm:py-32 md:pt-24 lg:pt-0 overflow-hidden">
          ...
          >
            <div className="relative overflow-hidden">
              ...
              >
                <Image
                  src="https://cdn.vendhub.com/video-poster-v2.jpg"
                  alt="VendCFO dashboard preview"
                  fill
                  fetchPriority="high"
                  quality={50}
                  sizes="100vw"
              ...
              >
                <source
                  src="https://cdn.vendhub.com/videos/login-video.mp4"
                  type="video/mp4"
                />
              </video>
      ...
      <WeeklyAudioSection audioUrl="https://cdn.vendhub.com/weekly-speech.mp3" />
