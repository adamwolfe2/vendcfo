...
import { RaycastMcpLogo } from "@vendcfo/app-store/logos";
            ...
            <div className="mt-12 space-y-4">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    Open Raycast's "Manage Servers" and edit VendCFO to add your
                    API key
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    @-mention VendCFO in Raycast AI to query your data
                  </span>
                </li>
              </ol>
            </div>
