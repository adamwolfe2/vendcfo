    ...
    <footer className="bg-background relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 py-16 sm:pb-80">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  {
                    href: "https://x.com/vendhubai",
                    label: "X / Twitter",
                    external: true,
                  },
                  {
                    href: "https://www.linkedin.com/company/vendhub-ai",
                    label: "LinkedIn",
                    external: true,
                  },
                ].map((item) => (
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <Link
            href="https://vendhub.openstatus.dev/"
            target="_blank"
          ...
          <p className="font-sans text-sm text-muted-foreground">
            © {new Date().getFullYear()} VendCFO Labs AB. All rights reserved.
          </p>
        </div>
      </div>
