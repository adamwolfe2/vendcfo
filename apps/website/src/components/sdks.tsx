...
export function SDKs() {
  ...
  const sdkRepos: Record<SDKTab, string> = {
    typescript: "https://github.com/vendhub-ai/vendhub-ts",
    go: "https://github.com/vendhub-ai/vendhub-go",
    php: "https://github.com/vendhub-ai/vendhub-php",
  };
          ...
          <div className="flex flex-col justify-start items-center z-20 px-4 sm:px-6">
            ...
            <div className="space-y-4 text-center max-w-xl w-full">
              ...
              <p className="text-muted-foreground text-base leading-normal font-sans text-center mx-auto">
                Use VendCFO's SDKs to integrate financial data, insights, and
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full max-w-md mx-auto justify-center sm:justify-center mt-8">
              ...
              >
                <Link href="https://api.vendhub.com">API documentation</Link>
              </Button>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center space-y-4">
                ...
                <p className="font-sans text-base text-muted-foreground leading-normal max-w-2xl mx-auto">
                  A fully typed SDK for interacting with VendCFO's APIs, designed
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <InstallTabs packageName="@vendcfo-ai/sdk" />
                  </div>
                  ...
                  <div>
                    ...
                    <CodeBlock
                      code={`import { VendCFO } from "@vendcfo-ai/sdk";

const vendhub = new VendCFO({
  security: {
...
async function run() {
  const result = await vendhub.oAuth.getOAuthAuthorization({
    responseType: "code",
...
run();`}
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button
                    ...
                    className="h-11 px-6 text-sm font-sans bg-background border-border hover:bg-accent"
                  >
                    <a href="https://github.com/vendhub-ai/vendhub-ts">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <CodeBlock
                    code="go get github.com/vendhub-ai/vendhub-go"
                    language="bash"
                  />
                </div>
...
import (
	"context"
	vendhubgo "github.com/vendhub-ai/vendhub-go"
	"github.com/vendhub-ai/vendhub-go/models/operations"
	"log"
)
...
func main() {
	...
	s := vendhubgo.New(
		vendhubgo.WithSecurity("MIDDAY_API_KEY"),
	)

	res, err := s.Transactions.List(ctx, operations.ListTransactionsRequest{
		PageSize: vendhubgo.Float64(50),
	})
	if err != nil {
		log.Fatal(err)
	}
		...
		// handle response
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button
                    ...
                    className="h-11 px-6 text-sm font-sans bg-background border-border hover:bg-accent"
                  >
                    <a href="https://github.com/vendhub-ai/vendhub-go">
                      View Go docs
                    </a>
                  </Button>
                  <Button
          ...
          {activeTab === "php" && (
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center space-y-4">
                ...
                <p className="font-sans text-base text-muted-foreground leading-normal max-w-2xl mx-auto">
                  A PHP SDK for integrating VendCFO's APIs into your PHP
                  applications.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <CodeBlock
                    code="composer require vendhub-ai/vendhub-php"
                    language="bash"
                  />
                </div>
...
use VendCFO\VendCFO;
use VendCFO\VendCFO\Models\Operations;

$sdk = VendCFO\VendCFO::builder()
    ...
    // handle response
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button
                    ...
                    className="h-11 px-6 text-sm font-sans bg-background border-border hover:bg-accent"
                  >
                    <a href="https://github.com/vendhub-ai/vendhub-php">
                      View PHP docs
                    </a>
                  </Button>
                  <Button
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="hidden sm:block font-sans text-base text-muted-foreground leading-normal max-w-2xl mx-auto">
              Use VendCFO SDKs to integrate financial data, insights, and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="font-sans text-sm text-muted-foreground">
                  Get started with VendCFO SDKs in minutes.
                </p>
              </Link>
              <Link
                href={sdkRepos[activeTab]}
