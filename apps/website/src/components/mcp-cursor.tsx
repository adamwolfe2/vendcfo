...
import { CursorMcpLogo } from "@vendcfo/app-store/logos";
...
const cursorConfig = {
  url: "https://api.vendhub.com/mcp",
  headers: {
    Authorization: "Bearer YOUR_API_KEY",
  },
};
const cursorDeepLink = `cursor://anysphere.cursor-deeplink/mcp/install?name=vendhub&config=${encodeURIComponent(btoa(JSON.stringify(cursorConfig)))}`;
            ...
            <div className="space-y-4 mb-12">
              <a href={cursorDeepLink} className="inline-block">
                <img
                  ...
                  alt="Add VendCFO MCP server to Cursor"
                  height={32}
            ...
            <div className="mt-12 space-y-4">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    Restart Cursor and @-mention VendCFO in chat
                  </span>
                </li>
              </ol>
            </div>
