...
import { apps as appStoreApps } from "@vendcfo/app-store";
...
> = {
  ...
  "vendhub-desktop": {
    ...
    installUrl: "https://vendhub.com/download",
  },
  "google-drive": {
    slug: "google-drive",
    features: [
  ...
  "cursor-mcp": {
    ...
    installUrl: "https://vendhub.com/mcp/cursor",
  },
  "claude-mcp": {
    slug: "claude-mcp",
    features: [
  ...
  "perplexity-mcp": {
    ...
    installUrl: "https://vendhub.com/mcp/perplexity",
  },
  "raycast-mcp": {
    slug: "raycast-mcp",
    features: [
    ...
    installUrl: "https://vendhub.com/mcp/raycast",
  },
  "chatgpt-mcp": {
    slug: "chatgpt-mcp",
    features: [
    ...
    installUrl: "https://vendhub.com/mcp/chatgpt",
  },
  "opencode-mcp": {
    slug: "opencode-mcp",
    features: [
    ...
    installUrl: "https://vendhub.com/mcp/opencode",
  },
  "zapier-mcp": {
    slug: "zapier-mcp",
    features: [
  ...
  "make-mcp": {
    ...
    installUrl: "https://vendhub.com/mcp/make",
  },
};
