...
const title = "Story";
const description =
  "Why we built VendCFO. Learn about our mission to help founders and small teams stay on top of their business finances without the manual work.";
          ...
          <div className="space-y-12">
            ...
            <div className="prose prose-sm sm:prose-base max-w-none space-y-8 font-sans text-foreground">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  VendCFO is built around the idea that your finances should stay
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Instead of pulling information out of the system, VendCFO
                ...
                <p className="text-muted-foreground leading-relaxed">
                  VendCFO doesn't replace your accountant. It sits in between,
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  VendCFO is built for founders and small teams who want to feel
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  Our goal is simple: when you use VendCFO, you shouldn't have to
