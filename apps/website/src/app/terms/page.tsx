...
const description =
  "Terms and Conditions for using VendCFO. Read about your rights and responsibilities when using our service.";
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  govern your relationship with the VendCFO application (the
                  "Service") operated by VendCFO Labs AB ("us", "we", or "our").
                </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    cancel it or VendCFO Labs AB cancels it. You may cancel your
                    Subscription through your online account management page or
                    by contacting VendCFO Labs AB's customer support.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If automatic billing fails, VendCFO Labs AB will issue an
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB may modify Subscription fees at its sole
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    and are granted at the sole discretion of VendCFO Labs AB.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB does not verify the accuracy or suitability
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB is not a financial advisor, accountant, or
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB accepts no liability for any consequences,
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    providers. VendCFO Labs AB does not verify the legal, tax, or
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB relies on third-party services (e.g., banking
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      VendCFO Labs AB cannot guarantee the completeness,
                    ...
                    <li>
                      VendCFO Labs AB shall not be liable for any loss, damage,
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      VendCFO Labs AB acts solely as a technical facilitator of
                    ...
                    <li>
                      VendCFO Labs AB is not responsible for errors, omissions,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    constitutes infringement, please email dmca@vendcfo.ai with:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    remain the property of VendCFO Labs AB and its licensors.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    services that are not controlled by VendCFO Labs AB.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    We assume no responsibility for third-party content, privacy
                    policies, or practices. You agree that VendCFO Labs AB shall
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB and its affiliates, directors, employees, and
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    VendCFO Labs AB regarding the Service.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-foreground leading-relaxed">
                    <a
                      href="mailto:support@vendcfo.ai"
