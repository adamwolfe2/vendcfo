...
summary: "VendHub is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions"
image: "/images/novu.png"
tag: "Engineering"
---

VendHub is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions, and access general information how your business actually are doing. And that includes well-timed notifications via emails and push notifications, carefully curated for your convenience.
...
We started with created our own package `@vendhub/notifications` where
...
And using our [New Transactions email](https://email.vendhub.com/preview/transactions) as an example, which is sent from a background job using Trigger.dev when you have new transactions.

```typescript
import { Notifications, Types, Events } from "@vendhub/notifications";
...
<br />
![VendHub - In App Notifications](/images/notification-center.gif)
<br />
Thanks to the SDK `@novu/headless` we implemented the notification center for VendHub
...
<br />
![VendHub - In App Notifications](/images/notification-settings.gif)

<br />
### The future of VendHub x Novu
...
While this is just a draft on how we are using Novu in production you can dig deeper into the codebase in our [repository](https://git.new/vendhub).
