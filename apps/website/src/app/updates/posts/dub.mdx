...
Earlier this week [Dub.co](http://Dub.co) shared our [customer story](https://dub.co/customers/vendhub) on why we choose Dub as our link-sharing infrastructure.
...
<br />
![VendHub - Overview](/images/overview.png)

<br />
If you look closely you can se our link looks like this: [https://go.vendhub.com/5eYKrmV](https://go.vendhub.com/5eYKrmV)
...
```typescript
const dub = new Dub({ projectSlug: "vendhub" });
...
<br />
You can find the source code for this in our repository [here](https://github.com/vendhub-ai/vendhub/tree/main/apps/dashboard/src/actions/report).
