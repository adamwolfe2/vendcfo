...
const description =
  "Privacy Policy for VendCFO. Learn how we collect, use, and protect your personal data.";
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  VendCFO Labs AB ("us", "we", or "our") operates the VendCFO
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Service is the VendCFO application operated by VendCFO
                        Labs AB
                      </p>
                    </div>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB uses the collected data for various purposes:
                  </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO's use of information received from Google APIs will
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If you are from the European Economic Area (EEA), VendCFO
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB may process your Personal Data because:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB will retain your Personal Data only for as
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB will also retain Usage Data for internal
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    VendCFO Labs AB will take all the steps reasonably necessary
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        If VendCFO Labs AB is involved in a merger, acquisition
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Under certain circumstances, VendCFO Labs AB may be
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        VendCFO Labs AB may disclose your Personal Data in the
                        good faith belief that such action is necessary to:
                      </p>
                      <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                        <li>To comply with a legal obligation</li>
                        <li>
                          To protect and defend the rights or property of VendCFO
                          Labs AB
                        </li>
                        <li>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    you have certain data protection rights. VendCFO Labs AB aims
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      ...
                      VendCFO Labs AB relied on your consent to process your
                      personal information.
                    </li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-2">
