...
description: How VendHub's AI automatically matches receipts to transactions and learns from your feedback.
section: inbox
order: 1
---

VendHub's inbox captures receipts and invoices, then uses AI to match them to your bank transactions. No more manual filing or searching for receipts at tax time.
...
VendHub's matching improves over time through several learning mechanisms:
...
## Getting receipts into VendHub

### Email forwarding

Every VendHub account has a unique inbox email address:
...
4. VendHub scans for receipts and invoices automatically
...
1. Connect your Slack workspace in [Inbox → Settings](https://vendcfo.vercel.app/inbox/settings)
2. Share any file to the connected channel
3. It appears in your VendHub inbox automatically
...
1. Go to [Inbox](https://vendcfo.vercel.app/inbox)
...
The purchase might be on an account you haven't connected. Check your connected accounts in [Settings → Accounts](https://vendcfo.vercel.app/settings/accounts).
...
- Connected email access is read-only—VendHub can't send emails
