...
Your revenue forecast shows how much money you can expect to receive in the coming months. Unlike simple projections that just extend past trends, VendHub builds your forecast from real, known sources of incoming revenue.
...
1. Go to [Overview](https://vendcfo.vercel.app)
...
- **Projected revenue**: What VendHub expects you'll receive (dashed line)
- **Confidence score**: How reliable the projection is

## How the forecast works

VendHub calculates your forecast by adding up known and expected revenue sources. This "bottom-up" approach is more accurate than simply assuming past trends will continue.
...
To keep forecasts realistic, VendHub automatically excludes:
...
The more information VendHub has, the better your forecast:
...
When you [track billable hours](/docs/track-time-timer), VendHub can estimate unbilled revenue. Link your tracked time to projects with hourly rates.
...
Set your base currency in [Settings](https://vendcfo.vercel.app/settings).
...
VendHub may show warnings on your forecast:
...
**"Limited history"**: Not enough historical data to calculate reliable baselines. Accuracy improves as you use VendHub longer.
