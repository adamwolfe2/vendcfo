...
Most bank exports work directly. VendHub maps common formats automatically.
...
4. Map columns to VendHub fields
5. Review the preview
6. Confirm import

## Column mapping

If VendHub doesn't recognize your columns automatically:

1. Match each CSV column to a VendHub field
...
- VendHub checks for duplicates based on date, amount, and description
