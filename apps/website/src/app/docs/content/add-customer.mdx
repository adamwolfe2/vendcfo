...
Customers in VendHub store the information you need for invoicing and tracking work.

## Add a customer

1. Go to [Customers](https://vendcfo.vercel.app/customers)
...
VendHub can automatically enrich customer profiles:
