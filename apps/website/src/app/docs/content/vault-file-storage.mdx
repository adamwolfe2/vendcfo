...
1. Go to [Vault](https://app.vendhub.com/vault)
...
Your storage limit depends on your plan. Check your current usage in [Settings → Billing](https://app.vendhub.com/settings/billing).
