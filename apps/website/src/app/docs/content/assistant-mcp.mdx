...
description: Use the VendHub assistant in your own tools via MCP.
section: assistant
order: 2
---

The VendHub assistant is available through the Model Context Protocol (MCP), letting you query your financial data from AI tools like Claude Desktop, Cursor, ChatGPT, and Raycast.

## What is MCP?

Model Context Protocol (MCP) is an open standard for connecting AI assistants to external data sources. Instead of copying and pasting data, MCP lets AI tools query your VendHub data directly and securely.

## Supported tools

VendHub MCP works with:
...
Add VendHub to your Claude Desktop configuration.
...
After saving, restart Claude Desktop. You should see VendHub in your available tools.
...
Use VendHub data while coding in Cursor.
...
Use VendHub with ChatGPT via custom GPTs or plugins.

### Custom GPT approach

1. Create a Custom GPT in ChatGPT
2. Add actions that call the VendHub API
3. Configure authentication with your API key

### Configuration

Use the VendHub API endpoints with your API key in the Authorization header:
...
Access VendHub from Raycast on Mac.

### Install the extension

1. Open Raycast
2. Search for "VendHub" in the Store
3. Install the extension

### Configure

1. Open Raycast preferences
2. Find the VendHub extension
3. Enter your API key

### Use it

Trigger Raycast and use VendHub commands to query your financial data.

---

## Available tools

The MCP integration provides access to all your VendHub data:
...
>
> **Assistant**: Based on your VendHub data:
> - Cash balance: $45,230
...
- Try running `npx @vendhub-ai/mcp` manually to test
