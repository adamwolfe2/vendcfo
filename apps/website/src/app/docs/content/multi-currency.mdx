...
description: How VendHub handles multiple currencies and exchange rates.
section: banking
order: 7
---

VendHub supports businesses operating in multiple currencies. Connect accounts in different currencies, track international transactions, and see unified reports in your base currency.
...
1. Go to [Settings → Accounts](https://vendcfo.vercel.app/settings/accounts)
...
You can connect bank accounts in any currency VendHub supports.
...
VendHub uses market exchange rates to convert currencies.
...
VendHub uses reliable market rates updated daily. Rates are for display purposes and may differ slightly from your bank's rates.
...
For tax purposes, you may need to track original currency amounts. VendHub stores both the original and converted amounts for every transaction.

## Supported currencies

VendHub supports all major world currencies including:
