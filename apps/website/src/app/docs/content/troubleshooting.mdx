...
1. Check the connection is still active in [Inbox Settings](https://app.vendhub.com/inbox/settings)
...
1. Verify Stripe is connected in [Invoice Settings](https://app.vendhub.com/settings/invoice)
...
1. Go to [Settings → Billing](https://app.vendhub.com/settings/billing)
