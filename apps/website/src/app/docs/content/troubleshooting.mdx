...
Quick solutions to common issues you might encounter with VendHub.
...
1. Check the connection is still active in [Inbox Settings](https://vendcfo.vercel.app/inbox/settings)
...
1. Verify Stripe is connected in [Invoice Settings](https://vendcfo.vercel.app/settings/invoice)
...
1. Go to [Settings → Billing](https://vendcfo.vercel.app/settings/billing)
...
1. **Email**: [support@vendhub.com](mailto:support@vendhub.com)
