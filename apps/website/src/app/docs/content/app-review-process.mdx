...
description: Get your OAuth app verified and listed in the VendHub app directory.
section: developer
order: 5
---

Once your OAuth app is working, you can submit it for review. Verified apps display a trust badge and can be listed in the VendHub app directory for users to discover.

## Why get verified?

### For users

- **Trust badge**: Verified apps show users that VendHub has reviewed the app
...
- **App directory listing**: Reach VendHub's user base
- **Partnership opportunities**: Connect with the VendHub team
...
- Apps work fully
- Users see a warning: "This app hasn't been verified by VendHub yet"
...
- [ ] App works with different VendHub accounts
...
After approval, you can opt to list your app in the VendHub app directory:
...
- Don't include "VendHub" unless you have permission
- Avoid misleading names that imply official VendHub features
...
- **Discord**: [go.vendhub.com/discord](https://go.vendhub.com/discord)
