...
If you have accounts in different currencies, VendHub converts them to your base currency using current exchange rates. Set your base currency in [Settings](https://app.vendhub.com/settings).
