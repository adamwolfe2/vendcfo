...
Recurring invoices save time for ongoing client relationships. Set it once, and VendHub sends invoices automatically.
...
1. Go to [Invoices](https://vendcfo.vercel.app/invoices) → **Create invoice**
