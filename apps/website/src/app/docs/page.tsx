...
const description =
  "Learn how to use VendCFO to run your business finances. Get answers about invoicing, banking, time tracking, reports, and more.";
...
const popularGuides = [
  {
    ...
    description: "What is VendCFO and how it helps you",
  },
  {
    title: "Quick Start",
