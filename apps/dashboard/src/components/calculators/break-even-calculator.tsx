      ...
      <CardContent>
        <div className="space-y-4 mb-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="be-fixed">Global Fixed Costs</Label>
              <Input
                type="number"
                id="be-fixed"
            ...
            <div>
              <Label htmlFor="be-margin">Avg Gross Margin (%)</Label>
              <Input
                type="number"
                id="be-margin"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="be-loc">Fixed Cost / Location</Label>
              <Input
                type="number"
                id="be-loc"
            ...
            <div>
              <Label htmlFor="be-debt">Monthly Debt ($)</Label>
              <Input
                type="number"
                id="be-debt"
        ...
        <div className="bg-secondary p-4 rounded-lg border border-border">
          ...
          <div className="space-y-3 font-mono text-sm">
            ...
            <div className="flex justify-between pt-2 border-t border-border">
              <span className="text-muted-foreground">Locations Required:</span>
              <span className="font-medium text-foreground">
                {results.locationsRequiredToBreakEven ===
          ...
          {results.locationsRequiredToBreakEven ===
            ...
            <div className="mt-3 text-xs text-red-600 bg-red-500/10 p-2 rounded">
              <strong>Warning:</strong> Locations are losing money on a unit
              basis. Break-even impossible without margin improvement.
            </div>
          )}
        </div>
      </CardContent>
