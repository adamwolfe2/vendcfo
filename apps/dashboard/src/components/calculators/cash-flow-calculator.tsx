...
export function CashFlowCalculator() {
  ...
  const runwayMonths =
    monthlyNet < 0
      ? inputs.currentCash / Math.abs(monthlyNet)
      ...
      <CardContent>
        <div className="space-y-4 mb-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="monthlyRevenue">Revenue / Mo</Label>
              <Input
                type="number"
                id="monthlyRevenue"
                name="monthlyRevenue"
            ...
            <div>
              <Label htmlFor="monthlyCogs">COGS / Mo</Label>
              <Input
                type="number"
                id="monthlyCogs"
                name="monthlyCogs"
                value={inputs.monthlyCogs}
                onChange={handleChange}
                className="mt-1"
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="fixedCosts">Fixed Costs / Mo</Label>
              <Input
                type="number"
                id="fixedCosts"
                name="fixedCosts"
            ...
            <div>
              <Label htmlFor="loanPayments">Loan Payments / Mo</Label>
              <Input
                type="number"
                id="loanPayments"
                name="loanPayments"
        ...
        <div className="bg-secondary p-4 rounded-lg border border-border">
          ...
          <div className="space-y-3 font-mono text-sm">
            <div className="flex justify-between">
              <span className="text-muted-foreground">Net Cash Flow / Mo:</span>
              <span
                className={`font-bold ${monthlyNet > 0 ? "text-green-600" : "text-red-500"}`}
              >
            ...
            <div className="flex justify-between">
              ...
              <span className="text-foreground">
                ${annualizedCashFlow.toLocaleString()}
              </span>
            </div>
