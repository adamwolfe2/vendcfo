        ...
        <div className="bg-secondary p-4 rounded-lg border border-border">
          ...
          <div className="grid grid-cols-2 gap-y-3 font-mono text-sm">
            ...
            <div className="text-right font-medium text-green-600">
              ${results.netProfitPerUnit}
            </div>
            <div className="text-muted-foreground">Gross Margin</div>
            <div
              className={`text-right font-bold ${results.grossMarginPct < 30 ? "text-red-500" : "text-green-600"}`}
            >
          ...
          {results.grossMarginPct < 30 && (
            <div className="mt-3 text-xs text-red-600 bg-red-500/10 p-2 rounded">
              Warning: Margin below 30%. Raise price to $
              {results.suggestedPrices.margin35} for 35%.
            </div>
          )}
        </div>
      </CardContent>
