...
export function LoginVideoBackground() {
  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden m-2">
      ...
      >
        <img
          src="https://vendhub.com/cdn-cgi/image/width=1000,quality=80,format=auto/https://cdn.vendhub.com/video-poster-v2.jpg"
          alt=""
      ...
      <video
        ...
        playsInline
        preload="auto"
        poster="https://vendhub.com/cdn-cgi/image/width=1000,quality=80,format=auto/https://cdn.vendhub.com/video-poster-v2.jpg"
      >
        <source
