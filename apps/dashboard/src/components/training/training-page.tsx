        ...
        <div className="mb-2 flex items-start justify-between gap-2">
          ...
          {showDelete && onDelete && (
            <button
              ...
              className="shrink-0 rounded p-1 text-[#999] transition-colors hover:bg-red-50 hover:text-red-600"
...
function AddVideoModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="relative w-full max-w-lg rounded-lg border border-[#e0e0e0] bg-white p-6 shadow-lg mx-4">
...
export function TrainingPage({
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full">
      ...
      {/* Tabs */}
      <div className="mb-6 flex items-center justify-between border-b border-[#e0e0e0]">
        ...
        {activeTab === "my-videos" && (
          <button
            ...
            className="mb-2 inline-flex items-center gap-1.5 rounded-md bg-[#111] px-3.5 py-2 text-sm font-medium text-white transition-colors hover:bg-[#333]"
          >
