...
export function UnifiedAppComponent({ app }: UnifiedAppProps) {
  ...
  const handleOnInitialize = async () => {
    ...
    try {
      ...
      // Handle apps with installUrl (like VendCFO Desktop download page)
      if (app.installUrl) {
        if (isDesktopApp()) {
        ...
        <div className="px-6 pb-6 flex gap-2 mt-auto">
          ...
          {app.installUrl ? (
            <Button
              ...
              disabled={!app.active}
            >
              {app.id === "vendhub-desktop" ? "Download" : "Install"}
            </Button>
          ) : app.installed ? (
            <SubmitButton
              variant="outline"
          ...
          <SheetHeader>
            ...
            <div className="mt-4">
              ...
              <div className="absolute bottom-4 pt-8 border-t border-border">
                ...
                <a
                  href="mailto:support@vendcfo.dev"
