  ...
  return (
    <button
      ...
      className={cn(
        ...
        isWebSearch
          ? "bg-[rgba(0,0,0,0.05)] hover:bg-[rgba(0,0,0,0.08)] rounded-full pr-2"
    ...
    >
      ...
      <span
        className={cn(
          "overflow-hidden transition-all duration-200 text-[12px] leading-[14px] font-medium whitespace-nowrap text-black",
          isWebSearch
