...
import { TabsList, TabsTrigger } from "@vendcfo/ui/tabs";
  ...
  return (
    <div className="flex justify-between items-end mb-6">
      ...
      <div className="flex items-center gap-2" data-no-close>
        ...
        <MetricsFilter />
        <div className="ml-2 relative flex items-stretch bg-[#f7f7f7] w-fit">
          <TabsList className="flex items-stretch h-auto p-0 bg-transparent">
            <TabsTrigger
              ...
              className={cn(
                ...
                "data-[state=active]:text-black data-[state=active]:bg-[#e6e6e6] data-[state=active]:mb-[-1px] data-[state=active]:z-10",
              )}
            >
              Overview
            </TabsTrigger>
