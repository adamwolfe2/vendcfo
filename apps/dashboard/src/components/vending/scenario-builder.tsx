...
import {
  type PriceChangeInputs,
  type PriceChangeOutputs,
...
export function ScenarioBuilder() {
  ...
  const [priceInputs, setPriceInputs] = useState<PriceChangeInputs>({
    currentRetailPrice: 1.5,
    proposedNewPrice: 2.0,
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    value={priceInputs.currentRetailPrice}
              ...
              <div>
                ...
                <Input
                  type="number"
                  id="sb-units"
                  name="currentMonthlyUnitSales"
                  value={priceInputs.currentMonthlyUnitSales}
                  onChange={handlePriceChange}
                  className="mt-1"
                />
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      step="0.25"
                      id="sb-new-price"
                      name="proposedNewPrice"
                      value={priceInputs.proposedNewPrice}
                      onChange={handlePriceChange}
                      className="mt-1"
                    />
                  </div>
                  <div>
                    <Label htmlFor="sb-elasticity">
                      Assumed Elasticity Drop (%)
                    </Label>
                    <p className="text-xs text-muted-foreground mb-2">
                      Expected volume decline per $0.25 price hike.
                    </p>
                    <Input
                      type="number"
                      id="sb-elasticity"
                      name="assumedElasticityDeclinePct"
                      value={priceInputs.assumedElasticityDeclinePct}
                      onChange={handlePriceChange}
                    />
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-3xl font-bold text-foreground">
                        ${priceResults.projectedNewGrossProfit.toLocaleString()}
                      </h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-card p-4 rounded-lg border border-red-500/20 shadow-sm">
                      ...
                      <p className="text-xl font-bold text-foreground">
                        ${priceResults.downsideScenarioProfit.toLocaleString()}
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">
                        If sales drop 1.5x expected
                      </p>
                    </div>
                    ...
                    <div className="bg-card p-4 rounded-lg border border-green-500/20 shadow-sm">
                      ...
                      <p className="text-xl font-bold text-foreground">
                        ${priceResults.upsideScenarioProfit.toLocaleString()}
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">
                        If volume holds steady
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {activeTab === "expansion" && (
          <div className="flex flex-col items-center justify-center p-12 text-center h-64 border-2 border-dashed border-border rounded-xl">
            ...
            <p className="text-muted-foreground max-w-sm mb-6">
              Model the ROI of acquiring new locations and purchasing new
              equipment or routes.
            </p>
