...
import { isValidLogoUrl } from "@vendcfo/invoice";
...
export default async function Image({ params }: Props) {
  ...
  const hedvigSerifFont = fetch(
    "https://cdn.vendhub.com/fonts/HedvigSerif/HedvigLettersSerif-Regular.ttf?c=1",
  ).then((res) => res.arrayBuffer());

  const hedvigSansFont = fetch(
    "https://cdn.vendhub.com/fonts/HedvigSans/HedvigLettersSans-Regular.ttf",
  ).then((res) => res.arrayBuffer());
