...
A Tauri-based desktop application for VendCFO that supports multiple environments with a native transparent titlebar on macOS.
...
### Staging Mode
```bash
# Run in staging environment (loads beta.vendhub.com)
