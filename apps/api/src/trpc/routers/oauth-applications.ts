...
import { AppInstalledEmail } from "@vendcfo/email/emails/app-installed";
import { AppReviewRequestEmail } from "@vendcfo/email/emails/app-review-request";
        ...
        if (!hasAuthorizedBefore) {
          ...
          if (userTeam && session.user.email) {
            ...
            await resend.emails.send({
              from: "VendCFO <vendhubbot@vendcfo.ai>",
