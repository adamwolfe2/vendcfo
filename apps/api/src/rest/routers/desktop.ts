...
const GITHUB_REPO = "vendhub-ai/vendhub";
...
const downloadQuerySchema = z.object({
  url: z
    ...
    .openapi({
      ...
      example:
        "https://github.com/vendhub-ai/vendhub/releases/download/vendhub-v1.0.0/VendCFO.app.tar.gz",
      param: {
        in: "query",
        name: "url",
        required: true,
...
function getGitHubHeaders(): Record<string, string> {
  const headers: Record<string, string> = {
    "User-Agent": "VendCFO-Desktop-Updater",
  };
...
app.openapi(
  createRoute({
    ...
    description:
      "Proxies the download of a desktop app update artifact from GitHub releases. Only URLs pointing to the vendhub-ai/vendhub repository are accepted.",
    tags: ["Desktop"],
    request: {
