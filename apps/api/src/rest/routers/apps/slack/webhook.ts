  ...
  async (c) => {
    ...
    try {
      ...
      if (type === "event_callback" && event) {
        ...
        // Use channel ID to help identify the correct VendCFO team
        ...
        const vendhubTeamId = slackApp.teamId;

        if (!vendhubTeamId) {
          logger.error("VendCFO team ID not found in app integration", {
            slackTeamId: team_id,
            appId: slackApp.id,
          });
          throw new HTTPException(400, {
