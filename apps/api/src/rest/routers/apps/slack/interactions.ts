...
import {
  ...
  ensureBotInChannel,
} from "@vendcfo/app-store/slack/server";
        ...
        if (isApprove) {
          ...
          try {
            ...
            await confirmSuggestedMatch(db, {
              ...
              inboxId,
              transactionId,
              userId: undefined, // Slack interactions don't have VendCFO user ID mapping
              teamId,
            });
                    ...
                    elements: [
                      {
                        ...
                        url: `${process.env.VENDCFO_DASHBOARD_URL || process.env.MIDDAY_DASHBOARD_URL || "https://vendcfo.vercel.app"}/transactions?id=${encodeURIComponent(transactionId)}`,
                ...
                blocks: [
                  {
                    ...
                    text: {
                      type: "mrkdwn",
                      text: "❌ *Match declined*\n\nThe suggestion has been dismissed. You can manually match this receipt in VendCFO.",
                    },
                  },
                  {
                    type: "actions",
                    elements: [
                      {
                        ...
                        url: `${process.env.VENDCFO_DASHBOARD_URL || process.env.MIDDAY_DASHBOARD_URL || "https://vendcfo.vercel.app"}/inbox?inboxId=${encodeURIComponent(inboxId)}`,
