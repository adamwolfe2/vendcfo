import { replicationCache } from "@vendcfo/cache/replication-cache";
import { teamPermissionsCache } from "@vendcfo/cache/team-permissions-cache";
import type { DatabaseWithPrimary } from "@vendcfo/db/client";
import { getUserTeamId } from "@vendcfo/db/queries";
