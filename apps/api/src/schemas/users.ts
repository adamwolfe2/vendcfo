...
export const updateUserSchema = z.object({
  ...
  avatarUrl: z
    .string()
    .url()
    .refine((url) => url.includes("vendhub.com"), {
      message: "avatarUrl must be a vendhub.com domain URL",
    })
    .optional()
    .openapi({
      description:
        "URL to the user's avatar image. Must be hosted on vendhub.com domain",
      example: "https://cdn.vendhub.com/avatars/jane-doe.jpg",
    }),
  ...
  team: z
    .object({
      ...
      logoUrl: z.string().url().openapi({
        ...
        example: "https://cdn.vendhub.com/logos/acme-corp.png",
      }),
