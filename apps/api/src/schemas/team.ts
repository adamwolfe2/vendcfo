...
export const updateTeamByIdSchema = z.object({
  ...
  logoUrl: z
    ...
    .refine((url) => url.includes("vendhub.com"), {
      message: "logoUrl must be a vendhub.com domain URL",
    })
    .optional()
    .openapi({
      description:
        "URL to the team's logo image. Must be hosted on vendhub.com domain",
      example: "https://cdn.vendhub.com/logos/acme-corp.png",
    }),
...
export const teamMemberResponseSchema = z.object({
  ...
  avatarUrl: z.string().url().nullable().openapi({
    ...
    example: "https://cdn.vendhub.com/avatars/john-doe.png",
  }),
});
