...
import { sendMatchNotification } from "@vendcfo/app-store/whatsapp/server";
import type { Database } from "@vendcfo/db/client";
import { getWhatsAppConnections } from "@vendcfo/db/queries";
import { getAppByAppId, getApps } from "@vendcfo/db/queries";
        ...
        blocks: [
          {
            ...
            text: {
              type: "mrkdwn",
              text: "You got some new transactions! We'll do our best to match these with receipts in your Inbox or you can simply upload them in your <slack://app?id=A07PN48FW3A|VendCFO Assistant>.",
            },
          },
          { type: "divider" },
